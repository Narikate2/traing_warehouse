...
Замечание:
  Код создания таблиц идентичен бронзовому слою, за исключением добавленного столбца для метаданных: 
  dwh_create_date - атрибут, отображающий время добавления данных
===================================
